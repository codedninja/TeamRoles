            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading clearfix">
                        ...
                        <a href="{{route('teamroles.index')}}" class="btn btn-sm btn-default pull-right">
                    ...
                    <div class="panel-body">
                        <table class="table table-striped">
                            ...
                            @foreach($team->users AS $user)
                                <tr>
                                    <td>{{$user->name}}</td>
                                    <td>{{ $user->teamRoleFor($team)->name }}</td>
                                    <td>
                                            ...
                                            @if(Auth::user()->id !== $user->id)
                                                <form style="display: inline-block;" action="{{route('teams.members.destroy', [$team, $user])}}" method="post">
                                                    ...
                                                    <div class="btn btn-group btn-group-xs">
                                                        <a href="{{ route('teamroles.members.edit', ['team_id'=>$team->id, 'user_id'=>$user->id]) }}" class="btn btn-default">Change Role</a>
